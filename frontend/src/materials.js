...
// Demo bill of materials — a cordless handheld vacuum. Every component and
// material is deliberately catalogued in the backend/data reference library
// (component_library / material_library), so the reference-library panel
// resolves in full. Each line carries its baseline material plus the FUNCTIONAL
// REQUIREMENTS that part actually has to meet (min tensile / service temp /
// food / outdoor). The swap engine picks the best lower-impact material that
